    ...
    if (buff_char[1] > 2) {
        ...
        if (buff_char[0] == 0) {
            if (buff_char[2] == 1) {
                buf_command[0] = 'B';
                buf_command[1] = 0;
                buf_command[2] = (buff_char[1] * 20 * (1 + (1 - float((9 - (float)buff_char[3])/9)))); // left back
                buf_command[3] = 0;
                buf_command[4] = (buff_char[1] * 20 * float((9 - (float)buff_char[3])/9)); // right back
                buf_command[5] = 'T';
                buf_command[6] = 1;
                buf_command[7] = (buff_char[1] * 20 * float((9 - (float)buff_char[3])/9)); // right back
                buf_command[8] = 1;
                buf_command[9] = (buff_char[1] * 20 * (1 + (1 - float((9 - (float)buff_char[3])/9)))); // left back
            }
            if (buff_char[2] == 0) {
                buf_command[0] = 'B';
                buf_command[1] = 0;
                buf_command[2] = (buff_char[1] * 20 * float((9 - (float)buff_char[3])/9)); // right back
                buf_command[3] = 0;
                buf_command[4] = (buff_char[1] * 20 * (1 + (1 - float((9 - (float)buff_char[3])/9)))); // left back
                buf_command[5] = 'T';
                buf_command[6] = 1;
                buf_command[7] = (buff_char[1] * 20 * (1 + (1 - float((9 - (float)buff_char[3])/9)))); // left back
                buf_command[8] = 1;
                buf_command[9] = (buff_char[1] * 20 * float((9 - (float)buff_char[3])/9)); // right back
            }
